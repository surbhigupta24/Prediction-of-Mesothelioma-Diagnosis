# -*- coding: utf-8 -*-
"""
Created on Mon Aug  5 20:39:09 2019
...
X = dataset.iloc[:,[0,1,2,5,7,10,11,12,14,15,16,19,22,23,24,25,27,31]] 
y = dataset.iloc[:, -1].values

#X = data.iloc[:,[0,1,2,5,7,10,11,12,14,15,16,19,22,23,24,25,27,31]] 
